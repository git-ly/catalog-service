...
class CatalogServiceApplicationTests {
    ...
    static void generateAccessTokens(){
        ...
        isabelleTokens = authenticateWith("isabelle","password",
                webClient);
    ...
    void whenPutRequestThenBookUpdated() {
        ...
        Book createdBook = webTestClient
                ...
                .expectBody(Book.class).value(book -> assertThat(book).isNotNull())
                .returnResult().getResponseBody();
        var bookToUpdate = new Book(createdBook.id(), createdBook.isbn(),
                createdBook.title(), createdBook.author(), 7.95,
                createdBook.publisher(), createdBook.createdDate(),
                createdBook.lastModifiedDate(), createdBook.createdBy(),
